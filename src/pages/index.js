...
export const query = graphql`
  query IndexQuery {
    ...
    bgDesktop: imageSharp(fluid: { originalName: { regex: "/telework-bg/" } }) {
      resize(width: 1200, quality: 90, cropFocus: CENTER) {
        src
      }
    }
    bgTablet: imageSharp(fluid: { originalName: { regex: "/telework-bg/" } }) {
      resize(width: 800, height: 1100, quality: 90, cropFocus: CENTER) {
        src
      }
    }
    bgMobile: imageSharp(fluid: { originalName: { regex: "/telework-bg/" } }) {
